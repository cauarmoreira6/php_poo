...
echo "O Funcionario $joao->nome é $joao->tipoFuncionario e o valor de desconto é: $joao->descontos.<br>";
echo "A funcionaria $maria->nome é $maria->tipoFuncionario e o valor de desconto é: $maria->descontos.<br>";
echo "O Funcionario $jose->nome é $jose->tipoFuncionario e o valor de desconto é: $jose->descontos.<br>";