...
echo "O Valor de desconto de $joao->nome é de R$ $joao->descontos. <br>";
echo "O Valor de desconto de $maria->nome é de R$ $maria->descontos. <br>";
echo "O Valor de desconto de $jose->nome é de R$ $jose->descontos. <br>";